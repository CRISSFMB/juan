...
import logoIS from "../assets/logo.jpg";
  ...
  return (
    <div className="container">
      ...
      <h2 className="text-xl font-semibold mt-6">
        Información de la Institución Educativa donde concluyó su Bachillerato:
      </h2>
      <form onSubmit={handleSubmit} className="formulario">
        <div className="form-row">
      ...
      <div className="form-row">
        <label htmlFor="mensuales">
          ¿Cuales son los ingresos mensuales de su hogar?:
        </label>
        <input
          type="text"
          id="mensuales"
          name="mensuales"
          value={formData.mensuales}
          onChange={handleChange}
        />
      </div>
      <h2 className="text-xl font-semibold mt-6">
      ...
      <form onSubmit={handleSubmit} className="formulario">
        <div className="form-row">
          <label htmlFor="catastrofica">
            ¿Tiene aluguna enfermedad catastrófica?
          </label>
          <input
            type="checkbox"
            id="catastrofica"
      ...
      <div className="button-group">
        <button onClick={() => handleSubmit("continuar")}>
          Guardar y Continuar
        </button>
      </div>
    </div>
